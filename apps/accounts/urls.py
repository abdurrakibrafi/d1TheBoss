...
urlpatterns = [
    ...
    path("register/initiate/", InitiateRegistrationView.as_view(), name="initiate-register"),
    path("register/complete/", CompleteRegistrationView.as_view(), name="complete-register"),
    ...
    path("profile/resend-email-change-otp/", ResendEmailChangeOTPView.as_view(), name="resend-email-change-otp"),
    path("profile/cancel-email-change/", CancelEmailChangeView.as_view(), name="cancel-email-change"),
