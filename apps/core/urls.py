...
urlpatterns = [
    path("legal/terms/", views.TermsAndConditionsView.as_view(), name="terms-conditions"),
    ...
    path('populate-onboarding-data/', views.populate_onboarding_data, name='populate_onboarding_data'),  # Add this line
]