...
class Denomination(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, blank=True, null=True) 
    denomination_option = models.ForeignKey(DenominationOption, on_delete=models.CASCADE, blank=True, null=True)
    name = models.CharField(max_length=200, blank=True, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class BibleFamiliarity(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, blank=True, null=True) 
    bible_familiarity_option = models.ForeignKey(BibleFamiliarityOption, on_delete=models.CASCADE, blank=True, null=True)
    text = models.CharField(max_length=250, blank=True, null=True)
...
class BibleVersion(models.Model):
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, blank=True, null=True) 
    bible_version_option = models.ForeignKey(BibleVersionOption, on_delete=models.CASCADE, blank=True, null=True)
