...
class JourneyReasonSerializer(serializers.ModelSerializer):
    journey_reason_detail = JourneyReasonOptionSerializer(source='journey_reason', read_only=True)

    class Meta:
        model = JourneyReason
        fields = ['id', 'journey_reason', 'journey_reason_detail', 'created_at', 'updated_at']
...
class DenominationSerializer(serializers.ModelSerializer):
    denomination_detail = DenominationOptionSerializer(source='denomination_option', read_only=True)

    class Meta:
        model = Denomination
        fields = ['id', 'denomination_option', 'denomination_detail', 'created_at', 'updated_at']
        read_only_fields = ['created_at', 'updated_at']
...
class TonePreferenceSerializer(serializers.ModelSerializer):
    tone_preference_detail = TonePreferenceOptionSerializer(source='tone_preference_option', read_only=True)

    class Meta:
        model = TonePreference
        fields = ['id', 'tone_preference_option', 'tone_preference_detail', 'created_at', 'updated_at']
        read_only_fields = ['created_at', 'updated_at']
...
class BibleFamiliaritySerializer(serializers.ModelSerializer):
    bible_familiarity_detail = BibleFamiliarityOptionSerializer(source='bible_familiarity_option', read_only=True)

    class Meta:
        model = BibleFamiliarity
        fields = ['id', 'bible_familiarity_option', 'bible_familiarity_detail', 'created_at', 'updated_at']
        read_only_fields = ['created_at', 'updated_at']
...
class BibleVersionSerializer(serializers.ModelSerializer):
    bible_version_detail = BibleVersionOptionSerializer(source='bible_version_option', read_only=True)

    class Meta:
        model = BibleVersion
        fields = ['id', 'bible_version_option', 'bible_version_detail', 'created_at', 'updated_at']
        read_only_fields = ['created_at', 'updated_at']
...
class UserOnboardingProgressSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = UserProfile
        fields = ['onboarding_step', 'onboarding_completed', 'onboarding_completed_at', 'progress_percentage']
